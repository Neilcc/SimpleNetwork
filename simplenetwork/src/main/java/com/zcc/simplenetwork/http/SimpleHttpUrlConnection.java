...
public abstract class SimpleHttpUrlConnection<T extends BaseHttpRequestData, R> extends Thread {
    ...
    public SimpleHttpUrlConnection setMethod(String method) {
...
//            conn.setRequestProperty("Charset", "UTF-8");
            ...
            Map<String, String> headers = IHeaderInfoBuilder.getHeaderMap();
